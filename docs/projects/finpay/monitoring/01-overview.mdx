...
import GrafanaPanel from '@site/src/components/GrafanaPanel';
...
<div style={{marginBottom: '24px'}}>
   ...
   <a  href="https://finpaymonitoring.grafana.net/public-dashboards/ee9e5f95496747208947ea966f7257b2"
    target="_blank"
...
|---|---|
| [App Instrumentation](./monitoring-instrumentation) | Adding prom-client, exposing /metrics |
| [Grafana Alloy Setup](./monitoring-alloy) | Installing and configuring the scrape agent |
| [Grafana Dashboard](./monitoring-dashboard) | Building panels with PromQL |
| [Security](./monitoring-security) | Keeping secrets out of git |
| [Production Deployment](./monitoring-production) | Monitoring the live Railway app |
